...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: `/profile/entrepreneur/${user.id || (user as any)._id}`, icon: <Building2 size={20} />, text: 'My Startup' },
  ...
  const investorItems = [
    ...
    { to: `/profile/investor/${user.id || (user as any)._id}`, icon: <CircleDollarSign size={20} />, text: 'My Portfolio' },
